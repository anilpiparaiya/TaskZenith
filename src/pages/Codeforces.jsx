...
import UserInformation  from "../components/CFstats/UserInfo";
import { Navbar } from "../components/CFstats/Navbar";
import Loader from "../components/CFstats/Loader";
import InputForm from "../components/CFstats/Inputform";
  ...
  return (
    <div className="overflow-x-hidden min-h-screen">
      ...
      <div className="min-h-screen flex flex-col items-center">
        ...
        {loading ? <Loader /> : <UserInformation userInfo={userInfo} userSolved={userSub} userRating={userRating} />}
      </div>
    </div>
  );
}
